...
public class MetaDataHandler {
    ...
    public void addMetadata(final CrawlingActivity crawlingActivity) {
        ...
        lstTriples.add(new Triple(nodeCrawlingActivity,MetaDataVocabulary.crawlCount.asNode(),NodeFactory.createLiteral(String.valueOf(crawlingActivity.getCounterforCrawler(dummyUri)))));
